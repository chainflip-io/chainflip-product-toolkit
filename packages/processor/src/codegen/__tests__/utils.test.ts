...
describe(diffSpecs, () => {
  it('returns an empty set if nothing has changed', () => {
    ...
    expect(diffSpecs(a, a)).toEqual(new Set());
  });
  ...
  it('returns a set of changed events', () => {
    ...
    expect(diffSpecs(a, b)).toEqual(new Set(['pallet1.event1']));
  });
  ...
  it('returns a set of added events', () => {
    ...
    expect(diffSpecs(a, b)).toEqual(new Set(['pallet1.event2']));
  });
  ...
  it('returns a set of changed and added events', () => {
    ...
    expect(diffSpecs(a, b)).toEqual(new Set(['pallet1.event1', 'pallet1.event2']));
  });
