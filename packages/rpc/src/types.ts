...
export type CfFailedCallTron = RpcResult<'cf_failed_call_tron'>;
export type CfFailedCallBsc = RpcResult<'cf_failed_call_bsc'>;
...
export type CfIngressEgressEvents = RpcResult<'cf_ingress_egress_events'>;
...
export type CfFailedCallTronResponse = RpcResponse<'cf_failed_call_tron'>;
export type CfFailedCallBscResponse = RpcResponse<'cf_failed_call_bsc'>;
...
export type CfIngressEgressEventsResponse = RpcResponse<'cf_ingress_egress_events'>;
