...
const liquidityProviderAccount: z.input<typeof liquidityProvider> = {
  ...
  refund_addresses: {
    ...
    Arbitrum: '0xacd7c0481fc71dce9e3e8bd4cca5828ce8302629',
    // Solana: '7zLEfU3nQKqnfrN2A5yNEiFd1Vt9D7maVaoSAV8invMT', // testing the default value funcitonality
  },
  ...
  earned_fees: {
    ...
    // Solana: { SOL: 0, USDC: 0 }, // testing the default value funcitonality
  },
};
