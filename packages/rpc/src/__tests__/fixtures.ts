...
export const ingressEgressEnvironment: z.input<typeof cfIngressEgressEnvironment> = {
  minimum_deposit_amounts: {
    ...
    Bsc: { BNB: '0x0', USDC: '0x0', USDT: '0x0', WBTC: '0x0' },
  ...
  egress_dust_limits: {
    ...
    Assethub: { DOT: '0x0', USDC: '0x0', USDT: '0x0' },
    Bsc: { BNB: '0x1', USDC: '0x1', USDT: '0x1', WBTC: '0x1' },
...
export const swappingEnvironment: z.input<typeof cfSwappingEnvironment> = {
  maximum_swap_amounts: {
    ...
    Bsc: { BNB: null, USDC: null, USDT: null, WBTC: null },
  ...
  network_fees: {
    regular_network_fee: {
      ...
      rates: {
        ...
        Bsc: { BNB: 0, USDC: 0, USDT: 0, WBTC: 0 },
        Tron: { TRX: 0, USDT: 0 },
      },
    },
...
export const tradingStrategiesLimits: z.input<typeof cfGetTradingStrategyLimits> = {
  minimum_deployment_amount: {
    ...
    Tron: { TRX: null, USDT: 20000000000 },
  },
...
export const vaultAddresses: z.input<typeof cfVaultAddresses> = {
  ethereum: {
  ...
  bitcoin: [
    [
      ...
      {
        Btc: [
          98, 99, 49, 112, 103, 48, 115, 57, 54, 100, 57, 97, 120, 51, 48, 120, 108, 99, 50, 53,
          117, 119, 115, 104, 57, 56, 113, 108, 56, 122, 121, 122, 99, 53, 120, 57, 114, 56, 99, 57,
          106, 116, 106, 112, 104, 53, 53, 48, 113, 108, 117, 51, 116, 103, 107, 115, 51, 104, 100,
          103, 112, 116,
        ],
      },
    ],
    [
      ...
      {
        Btc: [
          98, 99, 49, 112, 101, 121, 100, 121, 54, 116, 104, 117, 107, 55, 117, 56, 119, 113, 117,
          107, 56, 55, 97, 104, 114, 57, 101, 99, 53, 54, 55, 55, 52, 112, 106, 101, 115, 106, 100,
          99, 114, 103, 106, 54, 110, 52, 53, 109, 50, 117, 57, 102, 110, 114, 48, 113, 107, 109,
          110, 117, 104, 110,
        ],
      },
    ],
    [
      ...
      {
        Btc: [
          98, 99, 49, 112, 50, 97, 107, 106, 102, 56, 109, 99, 101, 56, 115, 108, 108, 103, 100, 56,
          99, 56, 102, 103, 56, 112, 113, 100, 104, 113, 119, 108, 55, 114, 116, 53, 108, 120, 103,
          114, 113, 120, 99, 102, 116, 99, 103, 115, 106, 122, 114, 104, 107, 56, 104, 115, 99, 56,
          99, 109, 122, 121,
        ],
      },
    ],
    [
      ...
      {
        Btc: [
          98, 99, 49, 112, 55, 101, 100, 100, 104, 118, 55, 119, 54, 122, 53, 104, 114, 122, 48, 99,
          106, 107, 57, 116, 103, 48, 118, 116, 115, 119, 97, 99, 101, 101, 48, 106, 117, 121, 48,
          121, 122, 99, 50, 100, 48, 51, 122, 56, 116, 53, 56, 116, 54, 104, 56, 113, 114, 121, 48,
          115, 102, 52,
        ],
      },
    ],
  ...
  // sol_vault_program: {
  //   Sol: [
  //     147, 68, 141, 13, 102, 11, 76, 248, 159, 235, 52, 134, 204, 140, 243, 156, 251, 78, 131, 49,
  //     160, 132, 2, 70, 206, 67, 87, 231, 140, 95, 19, 244,
  //   ],
  // },
  // sol_swap_endpoint_program_data_account: {
  //   Sol: [
  //     219, 84, 11, 166, 142, 142, 177, 129, 203, 77, 123, 204, 66, 45, 68, 69, 146, 221, 0, 196, 64,
  //     143, 239, 50, 28, 18, 85, 58, 63, 213, 237, 186,
  //   ],
  // },
  ...
  // bitcoin_vault: {
  //   Btc: [
  //     98, 99, 49, 112, 114, 108, 48, 57, 56, 109, 108, 115, 97, 100, 108, 56, 112, 114, 109, 103,
  //     113, 101, 55, 108, 117, 106, 103, 53, 54, 51, 121, 110, 50, 117, 122, 119, 118, 48, 54, 53,
  //     51, 117, 118, 115, 108, 104, 99, 54, 121, 102, 120, 55, 108, 48, 114, 113, 53, 106, 114, 101,
  //     52, 113,
  //   ],
  // },
  // solana_sol_vault: {
  //   Sol: [
  //     79, 225, 139, 34, 53, 126, 153, 0, 142, 169, 241, 103, 11, 90, 83, 48, 222, 84, 77, 142, 161,
  //     71, 83, 168, 137, 237, 92, 197, 91, 138, 85, 210,
  //   ],
  // },
  // solana_usdc_token_vault_ata: {
  //   Sol: [
  //     108, 182, 242, 132, 131, 59, 166, 43, 183, 141, 224, 232, 73, 123, 196, 96, 75, 11, 12, 12,
  //     53, 156, 119, 246, 194, 244, 51, 165, 208, 22, 72, 223,
  //   ],
  // },
  // solana_vault_swap_account: {
  //   Sol: [
  //     42, 219, 81, 29, 11, 128, 248, 54, 187, 148, 191, 209, 118, 235, 23, 149, 170, 22, 38, 209,
  //     101, 213, 90, 68, 136, 141, 228, 8, 196, 61, 200, 35,
  //   ],
  // },
